  ...
  return {
    ...
    sections: [
      ...
      },
      {
        title: '기술과 예고',
        lines: [
          '준비기는 감염경로를 표현하며 패시몬마다 1개입니다.',
          '전용기는 병원체의 특징을 표현하며 1개입니다. 전투당 한 번만 사용하고, 도전모드에서는 이상한 사탕으로 해금됩니다.',
      ...
      },
      {
        title: '보스와 적',
        lines: [
          '5층 단위로 적과 싸우며, 10층마다 적 대신 보스가 등장합니다.',
          '일반 적에게는 방어특성이 없습니다. 보스는 10층 단위로 올라갈수록 방어특성을 1개씩 더 보유합니다.',
          `보스 방어특성은 계열·감염 경로·외피·서식 위치·크기 축으로 나뉘며, 누적 반감은 ×${RESISTANCE_FLOOR}에서 멈춥니다. 파티를 여러 타입으로 채워보세요!`,
        ],
      },
    ],
  };
